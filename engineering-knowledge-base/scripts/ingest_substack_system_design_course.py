...
def main() -> None:
    parser = ArgumentParser(
        description=(
            "Collect the public SDCourse curriculum in Day 1..N order, create stitched study guides, "
            "and rebuild the local retrieval context."
        )
    )
    ...
    print("\nSDCourse learning context is ready under engineering-knowledge-base/output.")
